                ...
                <div className="relative h-[60vh] min-h-[400px] w-full overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-8 md:p-16">
                        <div className="max-w-7xl mx-auto">
                            <Reveal>
                                <Link to="/services" className="inline-flex items-center text-slate-400 hover:text-primary mb-6 transition-colors">
                        ...
                        <div className="lg:col-span-2 space-y-12">
                            <Reveal delay={0.2}>
                                <div className="prose prose-lg prose-invert max-w-none">
                                    <h3 className="text-2xl font-bold text-white mb-4">Tentang Project</h3>
                                    <p className="text-slate-300 leading-relaxed">
                                        {project.description}
                                    </p>

                                    {/* Placeholder for future content expansion */}
                                    <div className="mt-8 p-6 bg-surface rounded-2xl border border-white/5">
                                        <h4 className="text-xl font-bold text-white mb-3">Tantangan & Solusi</h4>
                        ...
                        <div className="lg:col-span-1">
                            <Reveal delay={0.4}>
                                <div className="bg-surface rounded-2xl p-6 border border-white/5 sticky top-24">
                                    <h3 className="text-xl font-bold text-white mb-6">Informasi Project</h3>
